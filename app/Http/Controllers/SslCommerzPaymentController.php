...
class SslCommerzPaymentController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        $order_details = DB::table('orders')
            ...
            ->select('transaction_id', 'shipping_status', 'currency', 'order_total')->first();

        if ($order_details->shipping_status == 'pending') {
        ...
        } else if ($order_details->shipping_status == 'Processing' || $order_details->shipping_status == 'Complete') {
            /*
