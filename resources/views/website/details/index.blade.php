                ...
                <div class="row align-items-center">
                                ...
                                <div class="large-5 column">
                                    <div class="xzoom-container">
                                        ...
                                        <div class="xzoom-thumbs">
                                            ...
                                            <a href="{{asset($otherImage->feature_image)}}"><img class="xzoom-gallery" width="80" src="{{asset($otherImage->feature_image)}}"  xpreview="{{asset($otherImage->feature_image)}}" title="The description goes here"></a>
                                            @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{$product->Selling_price}} BDT<span>{{$product->reguler_price}} BDT</span></h3>
                            <p class="info-text">{{$product->model}}</p>
