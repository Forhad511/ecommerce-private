        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-category">
                    <h3 class="heading">{{$items->category->name}}</h3>
                    <ul>
                        <li><a href="product-grids.html">{{$items->category->description}}</a></li>
                    </ul>
                    <div class="images">
                        <img src="{{asset($items->category->image)}}" alt="#">
                    </div>
                </div>
            </div>
            @endforeach
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <div class="price">
                                <span>{{$product->Selling_price}} BDT</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title">
                                        <a href="{{route('product.details',['id'=> $item->id])}}">{{$item->name}}</a>
                                    </h4>
                                    <ul class="review">
                                        <li><i class="lni lni-star-filled"></i></li>
                                        <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="price">
                                        <span>{{$item->Selling_price}} BDT</span>
                                    </div>
                                </div>
                            </div>
