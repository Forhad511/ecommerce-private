        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr/>
                    <form class="form-horizontal p-t-20" action="{{route('create.sub-category')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" id="" placeholder="Sub Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-3 control-label">Category Description <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="description" id="" placeholder="Sub CategoryDescription">
                            </div>
                        </div>
                        <div class="form-group row">
