            ...
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu">Manage Module</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('manage.order')}}">Order Module</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="chart-chartist.html">Manage Coupne</a></li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="map-google.html">Tex Setting</a></li>
                        <li><a href="map-vector.html">Shipping Setting</a></li>
                        <li><a href="map-vector.html">System Setting</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
